        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Valor = table.Column<double>(type: "float(14)", precision: 14, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoPedido = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantidade = table.Column<double>(type: "float(14)", precision: 14, scale: 2, nullable: false),
                    Valor = table.Column<double>(type: "float(14)", precision: 14, scale: 2, nullable: false),
